	...
	bool userDefinedRouting = false)
{
	...
	/// </summary>
	public IElasticsearchMappingResolver ElasticsearchMappingResolver { get; } = elasticsearchMappingResolver;
	...
	/// </summary>
	public bool SaveChildObjectsAsWellAsParent { get; } = saveChildObjectsAsWellAsParent;
	...
	/// </summary>
	public bool ProcessChildDocumentsAsSeparateChildIndex { get; } = processChildDocumentsAsSeparateChildIndex;
	...
	/// </summary>
	public bool UserDefinedRouting { get; } = userDefinedRouting;
}
}
